...
// Calender component implemented with jquery
// Refers to https://github.com/Hancoson/mobile-calendar/blob/master/index.js
        ...
        bindEvents: function () {
            ...
            $(_this.opts.confirmBtn).click(function () {
                ...
                if (_this.opts.okFunc) {
                    ...
                    throw new Error('okFunc function is not defined!');
                }
            });
